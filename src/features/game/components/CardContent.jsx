  ...
  return (
    <>
      <div
        className="card-art"
        ref={dragRef}
        style={{ '--accent': accentFor(card.category) }}
        {...dragListeners}
      >
        ...
        {status && (
          <span className={`card-result-dot ${status}`} aria-hidden="true">
            <i />
          </span>
        )}
      </div>
      <div className="card-body">
        ...
        {revealed && (
          <div className="answer-reveal">
            ...
            <span className={`correct-position ${status}`}>
              {t.correctPosition(correctPosition)}
            </span>
          </div>
        )}
        {showControls && (
