export default {
  ...
  streak:'sequência', pointsShort:'pts', oldest:'mais antigo', newest:'mais recente', cardsAria:'Cartas para ordenar',
  ...
  dragHint:'Arraste as cartas para ordenar, do mais antigo ao mais recente.', imageDisclaimer:'As imagens são ilustrativas e podem não representar fielmente os fatos.',
  ...
  endGame:'Fim de jogo', finishGreat:'Sua linha do tempo está afiada.', finishTry:'A história ainda consegue te surpreender.',
  ...
  playAgain:(n)=>`Jogar novamente · ${n} restante${n===1?'':'s'}`, completedToday:'Você já completou suas 3 partidas de hoje.',
 ...
 loginToSave:'Faça login para salvar seus pontos!',
  ...
  privacy:'Política de Privacidade', terms:'Termos de Uso', home:'Jogo',
  ...
  errors:{
    ...
    poolExhausted:'Você já jogou todas as rodadas ranqueadas disponíveis. Novos acontecimentos chegam em breve.',
  },
  ...
  categories:{ História:'História', Tecnologia:'Tecnologia', Ciência:'Ciência', Espaço:'Espaço', Invenções:'Invenções', Exploração:'Exploração', Cultura:'Cultura', Games:'Games', Internet:'Internet', 'Cinema & TV':'Cinema & TV', Música:'Música', Esportes:'Esportes', Transportes:'Transportes', Brasil:'Brasil' },
}
